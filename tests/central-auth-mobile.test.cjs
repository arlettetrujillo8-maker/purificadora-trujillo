...
assert.match(html, /meta name="app-build" content="20260816-reportes-duplicado-fix"/);
...
assert.match(sw, /20260816-reportes-duplicado-fix/);
...
assert.match(
  bootstrap,
  /operational-store\.js\?v=20260816-reportes-duplicado-fix/,
);
