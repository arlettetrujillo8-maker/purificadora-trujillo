...
assert.match(html, /meta name="app-build" content="20260814-simplified-container-flow"/);
...
assert.match(sw, /20260814-simplified-container-flow/);
...
assert.match(
  bootstrap,
  /operational-store\.js\?v=20260814-simplified-container-flow/,
);
