...
assert.match(html, /meta name="app-build" content="20260816-reporte-y-envases-fix"/);
...
assert.match(sw, /20260816-reporte-y-envases-fix/);
...
assert.match(
  bootstrap,
  /operational-store\.js\?v=20260816-reporte-y-envases-fix/,
);
