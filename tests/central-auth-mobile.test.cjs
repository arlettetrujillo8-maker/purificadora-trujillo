...
assert.match(html, /meta name="app-build" content="20260817-caja-automatica"/);
...
assert.match(sw, /20260817-caja-automatica/);
...
assert.match(
  bootstrap,
  /operational-store\.js\?v=20260817-caja-automatica/,
);
