...
assert.match(html, /meta name="app-build" content="20260815-cierre-modal-seguro"/);
...
assert.match(sw, /20260815-cierre-modal-seguro/);
...
assert.match(
  bootstrap,
  /operational-store\.js\?v=20260815-cierre-modal-seguro/,
);
