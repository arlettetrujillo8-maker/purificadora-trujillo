...
import { SUPABASE_CONFIG } from "../v3/supabase-config.js?v=20260816-sesion-y-inventario-fix";

export const SUPABASE_CLIENT_BUILD = "20260816-sesion-y-inventario-fix";
